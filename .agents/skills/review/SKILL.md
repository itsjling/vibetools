---
name: review
description: Review code changes for best practices, implementation quality, and optionally conformance to plan. Reviews uncommitted changes or specified files/commits.
---
